...
fun MaidRegisterScreen(
    ...
    Column(
        ...
        MaidAuthTextField(
            ...
            onValueChange = { onEvent(MaidAuthEvent.FullNameChanged(it)) },
            label = "Full Name",
        ...
        MaidPrimaryButton(
            text = "Register",
            onClick = {
                activity?.let { onEvent(MaidAuthEvent.SendOtpForRegistration(it)) }
            },
...
@Composable
private fun MaidRegisterScreenPreview() {
    MaidyTheme {
        MaidRegisterScreen(
            uiState = MaidAuthUiState(
                fullName = "",
...
@Preview(showBackground = true, showSystemUi = true)
@Composable
private fun MaidRegisterScreenFilledPreview() {
    MaidyTheme {
        MaidRegisterScreen(
            uiState = MaidAuthUiState(
                fullName = "Jane Smith",
...
@Preview(showBackground = true, showSystemUi = true)
@Composable
private fun MaidRegisterScreenLoadingPreview() {
    MaidyTheme {
        MaidRegisterScreen(
            uiState = MaidAuthUiState(
                fullName = "Jane Smith",
